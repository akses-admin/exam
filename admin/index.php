    ...
    <div class="card shadow-lg mt-4">
        <div class="card-header py-3">
            <div class="d-flex justify-content-between align-items-center px-3 pt-1">
                ...
                <div>
                    <a href="<?= BASE_URL . '/index.php?page=tambah_admin' ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Admin</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <?php foreach ($admin as $ad) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= BASE_URL . '/index.php?page=hapus_admin&id_admin=' . $ad['id_admin'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Ingin Menghapus Data?')"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <!-- MODAL EDIT -->
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control" id="recipient-name" name="email" value="<?= $ad['nama_admin']; ?>">
                                            </div>
                                            <div class="mb-1">
                                                <label for="recipient-name" class="col-form-label">email:</label>
                                                <input type="text" class="form-control" id="recipient-name" name="email" value="<?= $ad['email']; ?>">
                                            </div>
                                    </div>
